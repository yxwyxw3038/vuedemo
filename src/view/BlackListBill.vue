...
<div>
  ...
  <div>
    ...
    <el-form-item label="IP：" class="searchinput">
    <el-input v-model="searchAddress" placeholder="请输入IP查询条件" class="searchinput"  size="mini"   type="text" clearable></el-input>
  </el-form-item>
 ...
 <v-btn-group :userid="user.ID"  :menuid="this.menuid" @btnclick="mybtnclick" :loading="loading"></v-btn-group> 
  ...
  <el-table-column
    ...
    <el-table-column prop="Address" label="IP"   width="250px"  fixed>
    </el-table-column>
  ...
  <v-back-list-edit :id="dialogid" :name="dialogTitle" :dialogVisible.sync="dialogFormVisible" :dialogEditOrNew="dialogEditOrNew"  @dialogClose="dialogClose" ></v-back-list-edit>
</div> 
</template>
<script>
import btnGroup from '@/components/btnGroup';
import store from '../store/store.js';
import BlackListEdit from '@/components/BlackListBill/BlackListEdit'
  export default {
    ...
    indexMethod(index) {
     ...
     mybtnclick(btnMsg)
      ...
      delete()
       {
        ...
        var maxid=this.multipleSelection.length-1;
         for(var i=0;i< this.multipleSelection.length;i++)
         {
           ...
           this.loading=true;
           this.$api.post("Sys/DeleteBlackList", {  Token:this.$store.state.userInfo.Token,str:str}, response => {
           this.loading=false;
       ...
       search()
       {
        ...
        var BillParameter=[];
         ...
         if (this.searchAddress == null || this.searchAddress == undefined || this.searchAddress == "") {
           ...
           var   parameter=new Object();
             ...
             parameter.logic = "AND";
             parameter.value = this.searchAddress;
      ...
      init() {
        ...
        this.$api.post("Sys/GetAllBlackListInfo",{
    ...
    components: {
             ...
             'v-back-list-edit':BlackListEdit
    }
